...
class RoundProgressBar (context: Context, attrs: AttributeSet) :
    ...
    init {
        ...
        typeArray.apply {
            roundColor = getColor(R.styleable.circleProgressBar_newCircleColor, Color.GREEN)
            roundProgressColor = getColor(R.styleable.circleProgressBar_newCircleProgressColor, Color.BLUE)
            textColor = getColor(R.styleable.circleProgressBar_newTextColor, Color.RED)
