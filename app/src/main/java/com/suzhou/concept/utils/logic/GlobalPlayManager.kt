...
import com.suzhou.concept.utils.changeTimeTriple
...
控制全局的音频播放
 */
object GlobalPlayManager :Player.Listener{
     ...
     * 播放器是否被初始化
     * */
    private fun isNotInit()= (!::player.isInitialized)
