...
//import com.suzhou.concept.databinding.ActivityRankBinding
//import com.suzhou.concept.fragment.rank.RankTopicFragment
//import com.suzhou.concept.fragment.rank.StudyRankFragment
...
//    private val titleArray=arrayOf(topic,test,listen)
//
//    override fun ActivityRankBinding.initBinding() {
//        setTitleText("排行榜")
//        installStandRight(R.drawable.rank_share,clickRightEvent)
//        rankTab.apply {
//            titleArray.forEach {
...
//            toString()
//        }
//        val shareTitle="我在${getString(R.string.app_name)}的${selectText}排行中排名前列，你也来试试吧"
