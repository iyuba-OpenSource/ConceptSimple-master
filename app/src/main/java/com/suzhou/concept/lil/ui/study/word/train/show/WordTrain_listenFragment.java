 ...
 * @description:
 */
public class WordTrain_listenFragment extends Fragment {
     ...
     * @return
     */
    public static WordTrain_listenFragment getInstance(String wordType, int bookId,int voaId){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_word_train_listen,null);
        initView(rootView);
        return rootView;
    }
    ...
    private void initView(View rootView){
        ...
        audioView = rootView.findViewById(R.id.audio);
    }
    ...
    private void updateData(){
        ...
        if (TextUtils.isEmpty(curBean.first.getWordAudioUrl())){
            wordView.setText("暂无音频，请根据下列释义选择合适的单词\n"+curBean.first.getDef());
        }else {
            wordView.setText("选择符合音频内容的选项");
        }
    }
