...
//     * @param rxAction
//     */
//    public static void timerInMain(long milliSeconds, final RxAction rxAction) {
...
//    }
//
//    public static void timerInIO(long milliSeconds, final RxAction rxAction) {
//        Observable.timer(milliSeconds, TimeUnit.MILLISECONDS)
//                .subscribe(new Observer<Long>() {
//                    @Override
//                    public void onSubscribe(@NonNull Disposable disposable) {
...
//     * @param rxAction
//     */
//    public static void multiTimerInMain(long delay, long milliSeconds, final RxAction rxAction) {
