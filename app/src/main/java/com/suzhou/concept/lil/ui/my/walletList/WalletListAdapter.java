...
public class WalletListAdapter extends RecyclerView.Adapter<WalletListAdapter.WalletListHolder> {
    ...
    public WalletListHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_reward_mark,parent,false);
    ...
    class WalletListHolder extends RecyclerView.ViewHolder{
        ...
        public WalletListHolder(View binding){
            super(binding);

            type = binding.findViewById(R.id.type);
            reward = binding.findViewById(R.id.reward);
            time = binding.findViewById(R.id.time);
        }
    }
