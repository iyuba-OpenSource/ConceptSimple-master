package com.suzhou.concept.lil.data.library;
...
public interface TypeLibrary {
    ...
    class RefreshDataType{
        ...
        //界面类型
        public static final String study_read = "study_read";//原文界面
        public static final String study_other = "study_other";//其他界面
    }
    ...
    //练习题类型
    class ExerciseType{
        public static final String Exercise_multiChoice = "multiChoice";//选择题
        public static final String Exercise_voaStructure = "voaStructure";//填空题
    }
}
