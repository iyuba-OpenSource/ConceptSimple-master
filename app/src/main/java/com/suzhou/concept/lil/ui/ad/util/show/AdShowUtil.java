package com.suzhou.concept.lil.ui.ad.util.show;
...
public interface AdShowUtil {
    ...
    class NetParam{
        //新的接口版本使用的appId
        public static final int AppId = 2221;
    ...
    class Util{
        ...
        public static void setADBlock(){
            ...
            try {
                compileDate = new Date(DateUtil.toDateLong("2020-04-01 00:00:00",DateUtil.YMDHMS));
//            compileDate = new Date(DateUtil.toDateLong("2022-04-01 00:00:00",BuildConfig.COMPILE_DATETIME));
                //这里根据当前情况，扩展成3天
        ...
        public static boolean isADBlock(){
            return AdBlocker.getInstance().shouldBlockAd();
        }
    }
}
