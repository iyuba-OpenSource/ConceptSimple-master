...
import com.suzhou.concept.databinding.DialogLoadingLilBinding;
 ...
 * @description:
 */
public class LoadingMsgDialog extends AlertDialog {

    private Context context;
    private DialogLoadingLilBinding binding;

    public LoadingMsgDialog(@NonNull Context context) {
        super(context);
