package com.suzhou.concept.lil.data.bean;
 ...
 * @description:
 */
public class WordShowBean implements Serializable {
    ...
    public WordShowBean(String types, String bookId, String voaId, String id, String word, String pron, String def, String position, String sentence, String sentenceCn, String videoPic, String videoUrl, String wordAudioUrl, String sentenceAudioUrl) {
        this.types = types;
        this.bookId = bookId;
        this.voaId = voaId;
        this.id = id;
